...
public class TushujieyueEntity<T> implements Serializable {
	 ...
	 * 设置：借阅方式
	 */
	public void setJieyuefangshi(String jieyuefangshi) {
		this.jieyuefangshi = jieyuefangshi;
	}
	/**
	 * 获取：借阅方式
	 */
	public String getJieyuefangshi() {
		return jieyuefangshi;
	}
	/**
	 * 设置：用户账号
	 */
