...
public class TushujieyueController {
    ...
    public R page(@RequestParam Map<String, Object> params,TushujieyueEntity tushujieyue,
		...
		if(tableName.equals("yonghu")) {
			tushujieyue.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R info(@PathVariable("id") Long id){
		...
		tushujieyue = tushujieyueService.selectView(new EntityWrapper<TushujieyueEntity>().eq("id", id));
